...
# 1 especie
python oparse_metadata.py --tabla ../Supplememtary_Table_1.csv --especies "s__Mycobacterium intracellulare" --ruta_fasta "../genomes/Mycobacterium_intracellulare/*.fna" --salidas "../outputs"
